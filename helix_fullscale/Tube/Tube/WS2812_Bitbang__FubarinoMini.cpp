...
#include "WS2812_Bitbang__FubarinoMini.h"
...
// per the documentation, the fubarino mini
// runs at 48mhz, with a 4x divider,
// so, 83.3ns per instruction (12 cycles per uS)
...
#define NOP_20NS NOP;
#define NOP_100NS NOP_20NS NOP_20NS NOP_20NS // 3
#define NOP_200NS NOP_100NS NOP_100NS NOP_20NS // 7
#define NOP_800NS NOP_200NS NOP_200NS NOP_200NS NOP_200NS // 32
#define NOP_1000NS NOP_200NS NOP_200NS NOP_200NS NOP_200NS NOP_200NS //45

#define NOP_83NS NOP; NOP; NOP; NOP;
#define NOP_166NS NOP_83NS NOP_83NS
#define NOP_249NS NOP_83NS NOP_166NS  // exactly .25us
#define NOP_498NS NOP_249NS NOP_249NS // exactly .5us
#define NOP_830NS NOP_83NS NOP_249NS NOP_498NS
#define NOP_996NS NOP_498NS NOP_498NS // this is actually exactly 1us


#define NOP_SHORT_NS_MINUS NOP; NOP; NOP; NOP; NOP; NOP; NOP; //NOP3; NOP5;
#define NOP_SHORT_NS NOP_SHORT_NS_MINUS NOP;

//#define NOP_SHORT_NS NOP_200NS // as close to 200NS as possible
#define NOP_LONG_NS NOP_1000NS // as close to 1um as possible
#define NOP_MEDIUM_NS NOP_800NS // as close to 800NS as possible
...
#define TM1809_BIT_SET___TMPHIDE(X,N,_PORT)  \
    if( X & (1<<N) ) { \
       MASK_HI(_PORT,PINMASK); \
       NOP_LONG_NS; \
       MASK_LO(_PORT,PINMASK); \
...
void WS2812_Bitbang_Fm::show_parallel() {
