...
# Digistark 1.03 AVR specifics
# ----------------------------------
#
PLATFORM         := Digistark
BUILD_CORE       := avr
PLATFORM_TAG     := ARDUINO=103 DIGISPARK
APPLICATION_PATH := /Applications/Arduino.app/Contents/Resources/Java

APP_TOOLS_PATH   := $(APPLICATION_PATH)/hardware/tools/avr/bin
CORE_LIB_PATH    := $(APPLICATION_PATH)/hardware/tiny-digispark/cores/tiny
APP_LIB_PATH     := $(APPLICATION_PATH)/libraries
BOARDS_TXT       := $(APPLICATION_PATH)/hardware/tiny-digispark/boards.txt
